...
public class RouteResult<T>
{
	...
	/**
	 * Extracts the param in {@code pathParams} first, then falls back to the first matching param in {@code queryParams}.
	 * @param name
	 * @return {@code null} if there's no match
	 */
	...
	public List<String> params(String name)
	{
		...
		final List<String> aggregated = new ArrayList<>(values.size() + 1);

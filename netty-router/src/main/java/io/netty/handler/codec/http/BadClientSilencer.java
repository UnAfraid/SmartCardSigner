...
/**
 * This utility handler should be put at the last position of the inbound pipeline to catch all exceptions caused by bad client (closed connection, malformed request etc.) and server processing, then close the connection. By default exceptions are logged to Netty internal logger. You may need to
 * override {@link #onUnknownMessage(Object)}, {@link #onBadClient(Throwable)}, and {@link #onBadServer(Throwable)} to log to more suitable places.
 */
@Sharable

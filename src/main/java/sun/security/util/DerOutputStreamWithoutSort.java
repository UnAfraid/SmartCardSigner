...
/**
 * Created by Venci on 14.1.2016 ã..
 */
public class DerOutputStreamWithoutSort extends DerOutputStream {
    private static ByteArrayLexOrder lexOrder = new ByteArrayLexOrder();
    private static ByteArrayTagOrder tagOrder = new ByteArrayTagOrder();

    public DerOutputStreamWithoutSort(int var1) {
        super(var1);
    }

    public DerOutputStreamWithoutSort() {
    }
    ...
    public void write(byte var1, DerOutputStreamWithoutSort var2) throws IOException {
        this.write(var1);
        this.putLength(var2.count);
        this.write(var2.buf, 0, var2.count);
    }

    public void writeImplicit(byte var1, DerOutputStreamWithoutSort var2) throws IOException {
        this.write(var1);
    ...
    public void putSequence(DerValue[] var1) throws IOException {
        DerOutputStreamWithoutSort var2 = new DerOutputStreamWithoutSort();

        for(int var3 = 0; var3 < var1.length; ++var3) {
            var1[var3].encode(var2);
        }

        this.write((byte)48, (DerOutputStreamWithoutSort)var2);
    }
    ...
    public void putSet(DerValue[] var1) throws IOException {
        ...
        this.write((byte)49, (DerOutputStreamWithoutSort)var2);
    }
    ...
    private void putOrderedSet(byte var1, DerEncoder[] var2, Comparator<byte[]> var3) throws IOException {
        DerOutputStreamWithoutSort[] var4 = new DerOutputStreamWithoutSort[var2.length];

        for(int var5 = 0; var5 < var2.length; ++var5) {
            var4[var5] = new DerOutputStreamWithoutSort();
        ...
        DerOutputStreamWithoutSort var9 = new DerOutputStreamWithoutSort();

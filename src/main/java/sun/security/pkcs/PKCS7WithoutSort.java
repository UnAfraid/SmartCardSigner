...
public class PKCS7WithoutSort extends PKCS7 {
    ...
    public PKCS7WithoutSort(InputStream var1) throws ParsingException, IOException {
        super(var1);
        this.version = null;
    ...
    public PKCS7WithoutSort(DerInputStream var1) throws ParsingException {
        super(var1);
        this.version = null;
        this.digestAlgorithmIds = null;
        this.contentInfo = null;
    ...
    public PKCS7WithoutSort(byte[] var1) throws ParsingException {
        super(var1);
        this.version = null;
        this.digestAlgorithmIds = null;
        this.contentInfo = null;
    ...
    public PKCS7WithoutSort(AlgorithmId[] var1, ContentInfo var2, X509Certificate[] var3, X509CRL[] var4, SignerInfo[] var5) {
    ...
    public PKCS7WithoutSort(AlgorithmId[] var1, ContentInfo var2, X509Certificate[] var3, SignerInfo[] var4) {
    ...
    public void encodeSignedData(OutputStream var1) throws IOException {
        DerOutputStream var2 = new DerOutputStreamWithoutSort();
    ...
    public static byte[] generateSignedData(byte[] var0, X509Certificate[] var1, byte[] var2, String var3, URI var4, String var5) throws CertificateException, IOException, NoSuchAlgorithmException {
        ...
        PKCS7 var15 = new PKCS7(var13, var14, var1, var12);
    ...
    private static byte[] generateTimestampToken(Timestamper var0, String var1, byte[] var2) throws IOException, CertificateException {
        ...
        if(PKCS7WithoutSort.SecureRandomHolder.RANDOM != null) {
            var5 = new BigInteger(64, PKCS7WithoutSort.SecureRandomHolder.RANDOM);
            var4.setNonce(var5);
        }
